...
// CBS
void TwoLevelSearchCBS::recursiveFindNextLevinHLP(std::vector<BaseOption*> &optionPath, int maxDepth) {
...
void TwoLevelSearchCBS::LevinTS() {
    levinNodes_.clear();
 ...
 */
void TwoLevelSearchCBS::highLevelSearch() {
 ...
 */
void TwoLevelSearchCBS::highLevelSearchGemsInOrder() {
...
void TwoLevelSearchCBS::highLevelSearchDeterministic() {
    highlevelPlannedPath_.clear();
