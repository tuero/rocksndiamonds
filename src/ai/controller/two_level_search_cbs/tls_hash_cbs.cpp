 ...
 */
std::vector<uint64_t> TwoLevelSearchCBS::allOptionPairHashes() {
 ...
 */
uint64_t TwoLevelSearchCBS::optionPairHash(BaseOption *currOption, BaseOption *prevOption) {
 ...
 */
template<typename T>
std::vector<uint64_t> TwoLevelSearchCBS::givenPathOptionPairHashes(const T &pathContainer) {
    std::vector<uint64_t> optionPairHashes;
...
template std::vector<uint64_t> TwoLevelSearchCBS::givenPathOptionPairHashes<std::vector<BaseOption*>> (const std::vector<BaseOption*>&);
template std::vector<uint64_t> TwoLevelSearchCBS::givenPathOptionPairHashes<std::deque<BaseOption*>> (const std::deque<BaseOption*>&);
 ...
 */
uint64_t TwoLevelSearchCBS::optionIndexPairToHash(int indexCurr, int indexPrev) {
 ...
 */
TwoLevelSearchCBS::OptionIndexPair TwoLevelSearchCBS::hashToOptionIndexPair(uint64_t hash) {
 ...
 */
template<typename T>
uint64_t TwoLevelSearchCBS::optionPathToHash(const T &pathContainer) {
    uint64_t hash = 0;
...
template uint64_t TwoLevelSearchCBS::optionPathToHash<std::vector<BaseOption*>> (const std::vector<BaseOption*>&);
template uint64_t TwoLevelSearchCBS::optionPathToHash<std::deque<BaseOption*>> (const std::deque<BaseOption*>&);


std::vector<BaseOption*> TwoLevelSearchCBS::hashToOptionPath(uint64_t hash) {
...
template<typename T>
void TwoLevelSearchCBS::incrementPathTimesVisited(const T &pathContainer) {
...
template void TwoLevelSearchCBS::incrementPathTimesVisited<std::vector<BaseOption*>> (const std::vector<BaseOption*>&);
template void TwoLevelSearchCBS::incrementPathTimesVisited<std::deque<BaseOption*>> (const std::deque<BaseOption*>&);


template<typename T>
int TwoLevelSearchCBS::getPathTimesVisited(const T &pathContainer) {
...
template int TwoLevelSearchCBS::getPathTimesVisited<std::vector<BaseOption*>> (const std::vector<BaseOption*>&);
template int TwoLevelSearchCBS::getPathTimesVisited<std::deque<BaseOption*>> (const std::deque<BaseOption*>&);
