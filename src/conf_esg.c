...
element_to_special_graphic[] =
{
  ...
  {
    EL_INTERNAL_CLIPBOARD_CUSTOM,		GFX_SPECIAL_ARG_EDITOR,
    IMG_INTERNAL_CLIPBOARD_CUSTOM_EDITOR
  },
  {
    EL_INTERNAL_CLIPBOARD_GROUP,		GFX_SPECIAL_ARG_EDITOR,
    IMG_INTERNAL_CLIPBOARD_GROUP_EDITOR
  },
  {
